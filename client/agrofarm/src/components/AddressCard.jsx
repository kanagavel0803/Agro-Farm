...
const AddressCard = () => {
  ...
  const [selectedAddress, setSelectedAddress] = useState(
    addressState.addressList.find((address) => address.isChecked)?.id || ""
  );

  const handleAddressChange = (id) => {
    setSelectedAddress(id);
    dispatchAddress({ type: "SET-ADDRESS-ID", payload: id });
  };
          ...
          <div className="align-center">
            ...
            <label htmlFor={address.id} className="mg-left-auto fs-sm-plus">
              ...
              <i
                ...
                onClick={() => {
                  dispatchAddress({ type: "DELETE-ADDRESS", payload: address.id });
